/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 118848a63bd8b49832755ad76547067c)
...
interface __BaseEnv_Env {
	...
	REVIEW_AUTH_RATE_LIMITER: RateLimit;
	AI: Ai;
	ASSETS: Fetcher;
	AGENT_PROVIDER: "cloudflare";
	ALLOWED_ORIGINS: "";
	...
	DEEPSEEK_ENABLE_REASONING: "false";
	CLOUDFLARE_AI_MODEL: "@cf/meta/llama-3.1-8b-instruct-fp8-fast";
	SPEECH_ASR_MODEL: "@cf/openai/whisper-large-v3-turbo";
	SPEECH_TIMEOUT_MS: "19000";
	MAX_AUDIO_BYTES: "2097152";
	REVIEW_INVITE_CODE_SHA256: "6557739a67283a8de383fc5c0997fbec7c5721a46f28f3235fc9607598d9016b";
	REVIEW_SESSION_DAYS: "7";
