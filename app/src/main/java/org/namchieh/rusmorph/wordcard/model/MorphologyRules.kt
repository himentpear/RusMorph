...
object MorphologyRulesRepository {
    ...
    val nounRules: List<MorphologyRule> = listOf(
        ...
        MorphologyRule(
            ...
            endingToken = "-а",
            titleZh = "-а 型名词",
            subtitleRu = "Женский род на -а",
            genderZh = "通常为阴性（少数指人阳性）",
            summaryZh = "俄语中最典型、数量最多的 -а 结尾名词类别。",
            ...
            whyExplanation = "为什么 книга 的宾格是 книгу？在第一变格单数中，无论有生命还是无生命，-а 必须变成 -у（мама → маму, школа → школу, книга → книгу）。",
            examples = listOf("книга", "мама", "школа", "комната", "газета"),
        ),
        MorphologyRule(
            id = "noun_fem_ya",
            category = MorphologyCategory.NOUN,
            endingToken = "-я",
            titleZh = "阴性 -я 结尾名词",
            subtitleRu = "Женский род на -я",
            genderZh = "通常为阴性",
            summaryZh = "以软元音 -я 结尾的阴性名词。",
            ...
            whyExplanation = "-я 是 -а 的软化对应，宾格单数 -я 变为 -ю（неделя → неделю, деревня → деревню）。",
            examples = listOf("неделя", "деревня", "песня", "земля"),
        ),
        MorphologyRule(
            id = "noun_fem_soft",
            category = MorphologyCategory.NOUN,
